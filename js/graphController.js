function drawGraph(graphYLabels, audioSequence, sampleRate){
    ...
    console.log("Length of graphYLabels = " + graphYLabels.length.toString());
    console.log("Length of audio data = " + audioSequence.data.length.toString());
    ...
    // Initialize Axis
    var start_x_axis = 20.0;
    var start_y_axis = graphCanvasHeight - 20.0;
    var end_x_axis = graphCanvasWidth - 20.0;
    var end_y_axis = 20.0;
    ...
    context.fillText("ADSR Multiplier", 10, 10);
    
    context.textAlign = "center";
    context.fillText("0", 10, graphCanvasHeight - 10.0);
    
    context.textAlign= "right";
    context.fillText("seconds", graphCanvasWidth - 10.0, graphCanvasHeight - 10.0);
    ...
    // Set ending point
    var ending_point_x = end_x_axis - 50.0;
    var point_for_1_mult = end_y_axis + 50.0;
    
    var totalDuration = audioSequence.data.length / sampleRate;
    
    context.textAlign = "center";
    context.fillText(totalDuration.toString(), ending_point_x , start_y_axis + 10.0);
    
    context.fillText("1.0", start_x_axis - 10.0, point_for_1_mult);
